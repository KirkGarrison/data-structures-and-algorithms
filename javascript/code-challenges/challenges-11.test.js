...
const count = (target, input) => {
  ...
  input
    .map(numbers => numbers
      .forEach(numbers => numbers === target ? exactNumber++ : false));
  return exactNumber;
};
...
let findShortest = (data) => {
  // Solution code here...
  let shortest = data.reduce((firstHeight, secondHeight) => {
    Number(firstHeight.height) > Number(secondHeight.height) ? firstHeight = secondHeight : firstHeight = firstHeight;
    console.log(firstHeight.height);
