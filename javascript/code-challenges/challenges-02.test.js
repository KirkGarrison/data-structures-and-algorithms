...
const raisedToTheThird = (arr) => {
  // Solution code here...
  const raisedThird = [];
  arr.forEach((numbers) => raisedThird.push(Math.pow(numbers, 3)));
  return raisedThird;
};
...
const addOne = (arr) => {
  // Solution code here...
  return arr.map(numbers => numbers + 1);
};
...
const forLoopTwoToThe = (arr) => {
  ...
  for (let i = 0; i < arr.length; i++) {
    numbersPower.push(Math.pow(2, arr[i]));
  }
  return numbersPower;
};
...
const forEachTwoToThe = (arr) => {
  // Solution code here...
  const numbersPower = [];
  arr.forEach(numbers => numbersPower.push(Math.pow(2, numbers)));
  return numbersPower;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  return arr.map(numbers => Math.pow(2, numbers));
};
