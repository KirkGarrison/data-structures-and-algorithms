...
def test_repeated_word_2():
    actual = repeated_word('test is a test')
    expected = 'test'
    assert actual == expected


def test_repeated_word_sentence():
    assert repeated_word('Once upon a time in the west, there was a brave princess who...') == 'a'

def test_repeated_word_sentence_two():
...
def test_repeated_word_sentence_three():
